    ...
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a href="./" class="navbar-brand navbar-brand-img">
          <img src="<?php echo base_url();?>assets/img/mcwilliams.png" alt="Confluence">
        </a>
      </div> <!-- /.navbar-header -->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu noticebar-menu noticebar-hoverable" role="menu">                
              ...
              <li>
                <a href="./page-notifications.html" class="noticebar-item">
                  <span class="noticebar-item-image">
                    <img src="<?php echo base_url();?>assets/img/avatars/avatar-1-md.jpg" style="width: 50px" alt="">
                  </span>
              ...
              <li>
                <a href="./page-notifications.html" class="noticebar-item">
                  <span class="noticebar-item-image">
                    <img src="<?php echo base_url();?>assets/img/avatars/avatar-2-md.jpg" style="width: 50px" alt="">
                  </span>
        ...
        <ul class="nav navbar-nav navbar-right">    
          ...
          <li class="dropdown navbar-profile">
            <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;">
              <img src="<?php echo base_url();?>assets/img/avatars/avatar-1-xs.jpg" class="navbar-profile-avatar" alt="">
