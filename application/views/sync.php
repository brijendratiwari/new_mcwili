                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <div class="portlet">
                            ...
                            <p class="row-stat-label">Last Sync</p><h3 class="row-stat-value"><?php if(!empty($getAutoSyncUpdate)){ echo date_format(date_create($getAutoSyncUpdate[0]['SyncTime']),'g:i A');} else{ echo "00:00";}?></h3>
                            </div>
                            <div class="col-sm-4 col-md-6">
            ...
            <tfoot>
              <tr>
               <!--<th style="width: 30%">ID</th>-->
                ...
                <th style="width: 15%"><div><div class="subcol_BB">CD</div><div class="subcol_BB">FF</div><div class="subcol_BB">EB</div></div><div style="text-align: center;">Blackbox</div></th>
