         ...
         <div class="col-sm-6 col-md-3">
            ...
            <div class="col-sm-6 col-md-3">
              <div class="row-stat">
                ...
                <span class="label label-success row-stat-badge">+
                    <?php if($FilterCustomer['last_thirty'] !=0 ){ echo round( $FilterCustomer['last_thirty']/($FilterCustomer['last_thirty']+$FilterCustomer['previous_month'])*100); } else{ echo '0';} ?>% from previous month</span>
              </div> <!-- /.row-stat -->
            </div> <!-- /.col -->
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-3">
              <div class="row-stat">
                ...
                <span class="label label-success row-stat-badge">+
                    <?php if($mcSubscriber['month'] !=0) { echo round($mcSubscriber['month']/($mcSubscriber['previous_month']+$mcSubscriber['month'])*100);} else{ echo "0";} ?>% from previous month</span>
              </div> <!-- /.row-stat -->
            </div> <!-- /.col -->
...
<!--            <div class="col-sm-6 col-md-3">
        ...
        <div class="portlet-title">
          ...
          <span class="label label-success row-stat-badge">+
                    <?php if($celldoorSubscriber['total'] !=0){ echo round($celldoorSubscriber['year']/($celldoorSubscriber['year']+$celldoorSubscriber['total'])*100);} else{ echo '0';} ?>% from previous year</span>
...
<!--            <div class="col-sm-6 col-md-3">
            ...
            <div class="col-sm-6 col-md-3">
              <div class="row-stat">
                ...
                <span class="label label-success row-stat-badge">+
                    <?php if($celldoorSubscriber['month'] !=0) { echo round($celldoorSubscriber['month']/($celldoorSubscriber['previous_month']+$celldoorSubscriber['month'])*100);} else{ echo "0";} ?>% from previous month</span>
              </div> <!-- /.row-stat -->
            </div> <!-- /.col -->
            ...
            <div class="col-sm-6 col-md-3">
              <div class="row-stat">
                ...
                <span class="label label-success row-stat-badge">+
                    <?php if($celldoorSubscriber['last_thirty'] !=0) { echo round($celldoorSubscriber['last_thirty']/($celldoorSubscriber['previous_thirty']+$celldoorSubscriber['last_thirty'])*100); }else{ echo '0';} ?>% from previous 30 days</span>
              </div> <!-- /.row-stat -->
            </div> <!-- /.col -->
